                ...
                <View style={{ flexDirection: 'column', paddingTop: 20 }} >
                    ...
                    <View style={{ width: '95%', marginBottom: 10 }} >
                        <TouchableOpacity onPress={() => navigation.navigate('Forgot')}>
                            <Text style={{
                                fontSize: 17, fontFamily: 'OpenSans-SemiBold',
                    ...
                    <View style={{ alignItems: 'center' }}>
                        <TouchableOpacity style={{
                            ...
                            onPress={() => onLogin()}
                        >
                            <Text style={{ fontSize: 15, letterSpacing: 1.5, textAlign: 'center', position: 'relative', fontFamily: 'OpenSans-SemiBold', color: '#ffffff' }} >เข้าสู่ระบบ</Text>
                        </TouchableOpacity>
                    </View>
            ...
            <View style={{ flex: 2, backgroundColor: '#ffffff', flexDirection: 'column', paddingHorizontal: '3%' }} >
                ...
                <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'flex-end', backgroundColor: '#ffffff', marginBottom: 40 }} >
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('Register')}>
                        <Text style={{ fontSize: 18, fontFamily: 'OpenSans-SemiBold', color: '#333333' }} >Sign Up</Text>
                    </TouchableOpacity>
                </View>
