...
const Pay1 = ({ route, navigation }) => {
    ...
    onNextStep = async () => {
        ...
        if(photo === null || datetran === null || timer === null || bankname === null) {
            ...
            try {
                const respons = await axios.post('https://www.learnsbuy.com/api/bill_submit_course_pack', formData ,{
                            ...
                            <View style={{
                                ...
                                <View style={{
                                    ...
                                    <View style={{
                                        ...
                                        >
                                            ฿{numberWithCommas(course.c_pack_price)}
                                        </Text>
                                    </View>
                                </View>
                            </View>
