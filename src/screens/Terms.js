                ...
                <View style={{
                    ...
                    <View style={styles.ops}>
                        ...
                        <View style={{
                            ...
                            <Text style={{ fontSize: 12, marginTop: 10 ,fontFamily: "IBMPlexSansThai-Regular",}}>
                            ...
                            <Text style={{ fontSize: 12, fontFamily: "IBMPlexSansThai-Regular",}}>
                            ...
                            <Text style={{ fontSize: 12, marginTop: 20, fontFamily: "IBMPlexSansThai-Regular",}}>
